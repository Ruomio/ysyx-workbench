...
module ysyx_24080020(
    ...
    // Xbar
    wire arvalid_xbar_clint, arready_clint,
    ...
    wire [7:0] arlen_xbar_clint, arlen_xbar_soc,
                arlen_xbar_i;
    wire [`ysyx_24080020_WIDTH-1:0] araddr_xbar_clint,
                                    araddr_xbar_i;

    wire rvalid_clint, rready_xbar_clint,
        rready_xbar_i,
        rvalid_soc_i;
    ...
    wire [1:0] rresp_clint,
                rresp_soc_i;
    wire [`ysyx_24080020_WIDTH-1:0] rdata_clint,
                                    rdata_soc_i;

    wire awready_clint, awvalid_xbar_clint,
    ...
    wire [7:0] awlen_xbar_clint, awlen_xbar_soc,
                awlen_xbar_i;
    wire [`ysyx_24080020_WIDTH-1:0] awaddr_xbar_clint,
                                    awaddr_xbar_i;

    wire wvalid_xbar_clint, wready_clint,
    ...
    wire bvalid_clint, bready_xbar_clint,
        bvalid_soc_i,
        bready_xbar_i;
    wire [3:0] bid_clint,
                bid_soc_i;
