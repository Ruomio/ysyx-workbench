...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 101 00000 11100 11", csrrw  , I, ); 
  INSTPAT("??????? ????? ????? 110 00000 11100 11", csrrsi , I, ); 
  INSTPAT("??????? ????? ????? 111 00000 11100 11", csrrci , I, ); 

  /* RV32M */
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = (int)src1 * (int)src2); 
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = SEXT((uint64_t)src1 * (uint64_t)src2, 64) >> 32); 
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = SEXT((int64_t)src1 * (uint64_t)src2, 64) >> 32); 
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = SEXT(((uint64_t)src1 * (uint64_t)src2), 64) >> 32); 
