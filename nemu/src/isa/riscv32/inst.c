...
static void ecall(Decode *s) {
  ...
  assert(0);
#else
  s->dnpc = isa_raise_intr(isa_reg_str2val("a7", &success), s->pc + 4);
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, s->dnpc = CSR(MEPC_ADDR); CSR(MSTATUS_ADDR) = 0x1800;  IFDEF(CONFIG_DIFFTEST ,difftest_skip_ref());  /*assert(0)*/ );
